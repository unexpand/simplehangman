...
$$.JSArray = {"": "List/Interceptor;",
  ...
  contains$1: function(receiver, other) {
    var t1, t2, i;
    for (t1 = receiver.length, t2 = $.getInterceptor(other), i = 0; i < t1; ++i)
      if (t2.$eq(other, receiver[i]))
        return true;
    return false;
  },
...
$$._ForwardingStreamSubscription = {"": "_BaseStreamSubscription;_stream,_cancelOnError<,_liblib9$_subscription@,_liblib9$_onData,_onError,_onDone",
  ...
  _sendError$1: function(error) {
    ...
    if (this._cancelOnError) {
      t1 = this._liblib9$_subscription;
      t1.cancel$0(t1);
      this._liblib9$_subscription = null;
    }
  },
  ...
  _handleData$2: function(inputEvent, sink) {
    ...
    try {
      ...
      if (t1.get$_cancelOnError()) {
        t2 = t1.get$_liblib9$_subscription();
        t2.cancel$0(t2);
...
$$._WrappedList = {"": "ListBase;_liblib5$_list",
  get$iterator: function(_) {
    return $._WrappedIterator$($.get$iterator$ax(this._liblib5$_list));
  },
  get$length: function(_) {
...
$$.ConverterComponent = {"": "WebComponent;__e14<,__e15<,__t,ratio*,thing_one@,thing_two@,_host,_shadowRoots,_generatedRoots",
  created_autogenerated$0: function() {
    var root, t1, t2;
    root = this._createShadowRoot$0();
    t1 = this._generatedRoots;
    t1.$indexSet(t1, "x-converter", root);
    this.__t = $.Template$(root);
    t1 = $.getInterceptor$x(root);
    $.add$1$ax(t1.get$nodes(root), $.clone$1$x($.get$ConverterComponent___shadowTemplate(), true));
    this.__e14 = $.$index$asx($.get$nodes$x($.$index$asx(t1.get$nodes(root), 1)), 3);
    this.__t.listen$2($.get$onChange$x(this.__e14), new $.ConverterComponent_created_autogenerated_closure(this));
    this.__t.listen$2($.get$onInput$x(this.__e14), new $.ConverterComponent_created_autogenerated_closure0(this));
    t2 = this.__t;
    t2.oneWayBind$4;
    t2.children.push($.DomPropertyBinding$(new $.ConverterComponent_created_autogenerated_closure1(this), new $.ConverterComponent_created_autogenerated_closure2(this), false, false));
    this.__e15 = $.$index$asx($.get$nodes$x($.$index$asx(t1.get$nodes(root), 1)), 5);
    this.__t.listen$2($.get$onChange$x(this.__e15), new $.ConverterComponent_created_autogenerated_closure3(this));
    this.__t.listen$2($.get$onInput$x(this.__e15), new $.ConverterComponent_created_autogenerated_closure4(this));
    t1 = this.__t;
    t1.oneWayBind$4;
    t1.children.push($.DomPropertyBinding$(new $.ConverterComponent_created_autogenerated_closure5(this), new $.ConverterComponent_created_autogenerated_closure6(this), false, false));
    this.__t.create$0();
  },
...
$$.ConverterComponent_created_autogenerated_closure = {"": "Closure;this_0",
  call$1: function($$event) {
    var t1 = this.this_0;
    t1.set$thing_two($.JSNumber_methods.toStringAsFixed$1($.$div$n($.Primitives_parseDouble(t1.get$thing_one(), null), $.get$ratio$x(t1)), 2));
  },
  $isFunction: true
};

$$.ConverterComponent_created_autogenerated_closure0 = {"": "Closure;this_1",
  call$1: function($$event) {
    var t1 = this.this_1;
    t1.set$thing_one($.get$value$x(t1.get$__e14()));
  },
  $isFunction: true
};

$$.ConverterComponent_created_autogenerated_closure1 = {"": "Closure;this_2",
  call$0: function() {
...
$$.ConverterComponent_created_autogenerated_closure2 = {"": "Closure;this_3",
  call$1: function(e) {
    var t1 = this.this_3;
...
$$.ConverterComponent_created_autogenerated_closure3 = {"": "Closure;this_4",
  call$1: function($$event) {
    var t1 = this.this_4;
    t1.set$thing_one($.toStringAsFixed$1$n($.$mul$n($.Primitives_parseDouble(t1.get$thing_two(), null), $.get$ratio$x(t1)), 2));
  },
  $isFunction: true
};

$$.ConverterComponent_created_autogenerated_closure4 = {"": "Closure;this_5",
  call$1: function($$event) {
    var t1 = this.this_5;
    t1.set$thing_two($.get$value$x(t1.get$__e15()));
  },
  $isFunction: true
};

$$.ConverterComponent_created_autogenerated_closure5 = {"": "Closure;this_6",
  call$0: function() {
...
$$.ConverterComponent_created_autogenerated_closure6 = {"": "Closure;this_7",
  call$1: function(e) {
    var t1 = this.this_7;
    if (!$.$eq($.get$value$x(t1.get$__e15()), e))
      $.set$value$x(t1.get$__e15(), e);
  },
  $isFunction: true
};
...
$$.init_autogenerated_closure0 = {"": "Closure;box_1",
  call$1: function(e) {
    var t1 = this.box_1;
    if (!$.$eq($.get$ratio$x($.get$xtag$x(t1.__e0_1)), e))
      $.set$ratio$x($.get$xtag$x(t1.__e0_1), e);
  },
  $isFunction: true
};
...
$$.init_autogenerated_closure2 = {"": "Closure;box_1",
  call$1: function(e) {
    var t1 = this.box_1;
    if (!$.$eq($.get$ratio$x($.get$xtag$x(t1.__e1_2)), e))
      $.set$ratio$x($.get$xtag$x(t1.__e1_2), e);
  },
  $isFunction: true
};
...
$$.init_autogenerated_closure4 = {"": "Closure;box_1",
  call$1: function(e) {
    var t1 = this.box_1;
    if (!$.$eq($.get$ratio$x($.get$xtag$x(t1.__e2_3)), e))
      $.set$ratio$x($.get$xtag$x(t1.__e2_3), e);
  },
  $isFunction: true
};
...
$$.init_autogenerated_closure6 = {"": "Closure;",
  call$3: function($$list, $$index, __t) {
    var __binding3 = __t.contentBind$2(new $.init_autogenerated__closure7($.$index$asx($$list, $$index)), false);
    $.addAll$1$ax(__t, [document.createTextNode(" "), __binding3, document.createTextNode(" ")]);
  },
  $isFunction: true
};

$$.init_autogenerated__closure7 = {"": "Closure;character_2",
  call$0: function() {
...
$$.init_autogenerated_closure7 = {"": "Closure;",
  call$0: function() {
    if ($.observeReads())
      $.notifyRead($.get$__changes(), 1, "dead");
    if (!$.__$dead) {
      if ($.observeReads())
        $.notifyRead($.get$__changes(), 1, "won");
      var t1 = !$.__$won;
    } else
      t1 = false;
    return t1;
...
$$.init_autogenerated_closure8 = {"": "Closure;__html0_3,__html1_4,__html2_5",
  call$1: function(__t) {
    var t1, __e7, __e10, t2;
    t1 = {};
    t1.__e5_0 = null;
    t1.__e5_0 = this.__html0_3.cloneNode(true);
    __t.listen$2($.get$onInput$x(t1.__e5_0), new $.init_autogenerated__closure(t1));
    __t.listen$2($.get$onKeyUp$x(t1.__e5_0), new $.init_autogenerated__closure0());
    __t.oneWayBind$4(new $.init_autogenerated__closure1(), new $.init_autogenerated__closure2(t1), false, false);
    __e7 = $.clone$1$x(this.__html1_4, true);
    __t.conditional$3($.$index$asx($.get$nodes$x(__e7), 1), new $.init_autogenerated__closure3(), new $.init_autogenerated__closure4());
    __e10 = $.clone$1$x(this.__html2_5, true);
    t2 = $.getInterceptor$x(__t);
    t2.loop$3(__t, $.$index$asx($.get$nodes$x(__e10), 1), new $.init_autogenerated__closure5(), new $.init_autogenerated__closure6());
    t2.addAll$1(__t, [document.createTextNode("\n        Guess a letter...\n        "), t1.__e5_0, document.createTextNode("\n        "), __e7, document.createTextNode("\n        "), __e10, document.createTextNode("\n    ")]);
  },
  $isFunction: true
};

$$.init_autogenerated__closure = {"": "Closure;box_0",
  call$1: function($$event) {
    var t1 = $.get$value$x(this.box_0.__e5_0);
    if ($.hasObservers($.get$__changes()))
      $.notifyChange($.get$__changes(), 1, "guessedletter", $.__$guessedletter, t1);
    $.__$guessedletter = t1;
  },
  $isFunction: true
};
...
$$.init_autogenerated__closure1 = {"": "Closure;",
  call$0: function() {
    if ($.observeReads())
      $.notifyRead($.get$__changes(), 1, "guessedletter");
...
$$.init_autogenerated__closure2 = {"": "Closure;box_0",
  call$1: function(e) {
    var t1, t2;
    t1 = this.box_0.__e5_0;
    t2 = $.getInterceptor$x(t1);
    if (!$.$eq(t2.get$value(t1), e))
      t2.set$value(t1, e);
  },
  $isFunction: true
};
...
$$.init_autogenerated__closure3 = {"": "Closure;",
  call$0: function() {
    return !$.$eq($.get$length$asx($.get$wrongletters()), 0);
  },
  $isFunction: true
};

$$.init_autogenerated__closure4 = {"": "Closure;",
  call$1: function(__t) {
    $.add$1$ax(__t, document.createTextNode(" Sorry! The word contains no: "));
  },
  $isFunction: true
};

$$.init_autogenerated__closure5 = {"": "Closure;",
  call$0: function() {
...
$$.init_autogenerated__closure6 = {"": "Closure;",
  call$3: function($$list, $$index, __t) {
    var __binding8 = __t.contentBind$2(new $.init_autogenerated___closure($.$index$asx($$list, $$index)), false);
    $.addAll$1$ax(__t, [document.createTextNode(" "), __binding8, document.createTextNode(" ")]);
  },
  $isFunction: true
};

$$.init_autogenerated___closure = {"": "Closure;wrongchar_6",
  call$0: function() {
    return this.wrongchar_6;
  },
  $isFunction: true
};
...
$$.init_autogenerated_closure10 = {"": "Closure;",
  call$1: function(__t) {
    $.add$1$ax(__t, document.createTextNode(" You're dead! "));
  },
  $isFunction: true
};
...
$$.init_autogenerated_closure12 = {"": "Closure;",
  call$1: function(__t) {
    $.add$1$ax(__t, document.createTextNode(" You Win! "));
  },
  $isFunction: true
};
...
$$.ObservableList = {"": "ListMixinWorkaround_Observable;_liblib8$_list,$$_observers,$$_changes,hashCode",
  ...
  toString$0: function(_) {
    ...
    result = $.StringBuffer$("");
    $.ToString__emitValue(this._liblib8$_list, result, $.List_List($, null));
    return result._contents;
  },
...
$$.ObservableMap = {"": "Observable;_liblib7$_map,_liblib7$_keys,_values,$$_observers,$$_changes,hashCode",
  get$keys: function(_) {
    return this._liblib7$_keys;
  },
  get$values: function(_) {
    return this._values;
  },
  ...
  containsKey$1: function(_, key) {
    ...
    return $.containsKey$1$x(this._liblib7$_map, key);
  },
  $index: function(_, key) {
    var t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this, 2, key);
    return $.$index$asx(this._liblib7$_map, key);
  },
  $indexSet: function(_, key, value) {
  ...
  clear$0: function(_) {
    ...
    if (t2 != null) {
      ...
      t2 = false;
    if (t2 && $.$gt$n(len, 0)) {
      $.forEach$1$ax(t1, new $.ObservableMap_clear_closure(this));
  ...
  forEach$1: function(_, f) {
    ...
    if (t1 != null) {
      ...
      $.forEach$1$ax($.get$keys$x(this._liblib7$_map), this.get$_notifyReadKey());
    }
    $.forEach$1$ax(this._liblib7$_map, f);
  },
  toString$0: function(_) {
    var result = $.StringBuffer$("");
    $.ToString__emitPair(this, result, $.List_List($, null));
...
$$._ObservableMapKeyIterable = {"": "IterableBase;_liblib7$_map",
  get$iterator: function(_) {
    return $._ObservableMapKeyIterator$(this._liblib7$_map);
  },
  $asIterableBase: function (K, V) { return [K]; },
  $asIterable: function (K, V) { return [K]; }
};

$$._ObservableMapKeyIterator = {"": "Object;_liblib7$_map,_liblib7$_keys,_liblib7$_hasNext",
  moveNext$0: function() {
    var t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this._liblib7$_map, 1, "length");
    t1 = this._liblib7$_keys.moveNext$0();
    this._liblib7$_hasNext = t1;
    return t1;
  },
  get$current: function() {
    var key = this._liblib7$_keys.get$current();
    if ($.observeReads() && this._liblib7$_hasNext === true)
      this._liblib7$_map._notifyReadKey$1(key);
    return key;
  }
};

$$._ObservableMapValueIterable = {"": "IterableBase;_liblib7$_map",
  get$iterator: function(_) {
    return $._ObservableMapValueIterator$(this._liblib7$_map);
  },
  $asIterableBase: function (K, V) { return [V]; },
  $asIterable: function (K, V) { return [V]; }
};

$$._ObservableMapValueIterator = {"": "Object;_liblib7$_map,_liblib7$_keys,_values,_liblib7$_hasNext",
  moveNext$0: function() {
    var t1, moreKeys, moreValues;
    t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this._liblib7$_map, 1, "length");
    moreKeys = this._liblib7$_keys.moveNext$0();
    ...
    this._liblib7$_hasNext = moreValues;
    return moreValues;
  },
  get$current: function() {
    if ($.observeReads() && this._liblib7$_hasNext === true)
      this._liblib7$_map._notifyReadKey$1(this._liblib7$_keys.get$current());
...
$$.ObservableSet = {"": "IterableWorkaround_Observable;_liblib6$_map,_createMap,$$_observers,$$_changes,hashCode",
  contains$1: function(_, value) {
    ...
    return $.containsKey$1$x(this._liblib6$_map, value);
  },
  add$1: function(_, value) {
    var t1, t2, len;
  ...
  clear$0: function(_) {
    ...
    if (t1 != null) {
      t1.get$head;
      t1 = t1._liblib1$_head != null;
    } else
      t1 = false;
    if (t1) {
      for (t1 = this._liblib6$_map, t2 = $.get$iterator$ax($.get$keys$x(t1)); t2.moveNext$0() === true;) {
...
$.ConverterComponent$ = function() {
  return new $.ConverterComponent(null, null, null, 0.5, "0", "0", null, null, $.makeLiteralMap([]));
};
...
$.checkit = function() {
  ...
  if ($.observeReads())
    $.notifyRead($.get$__changes(), 1, "guessedletter");
  if ($.JSArray_methods.contains$1(t1, $.__$guessedletter)) {
    $.revealletters();
    if ($.contains$1$asx($.get$hyphens(), "-") !== true) {
      if ($.hasObservers($.get$__changes()))
        $.notifyChange($.get$__changes(), 1, "won", $.__$won, true);
      $.__$won = true;
    }
  } else {
    t1 = $.get$wrongletters();
    if ($.observeReads())
      $.notifyRead($.get$__changes(), 1, "guessedletter");
    $.add$1$ax(t1, $.__$guessedletter);
    if ($.$eq($.get$length$asx($.get$wrongletters()), 7)) {
      if ($.hasObservers($.get$__changes()))
        $.notifyChange($.get$__changes(), 1, "dead", $.__$dead, true);
      $.__$dead = true;
    }
  }
  if ($.hasObservers($.get$__changes()))
    $.notifyChange($.get$__changes(), 1, "guessedletter", $.__$guessedletter, "");
  $.__$guessedletter = "";
};

$.revealletters = function() {
  var i, t1;
  for (i = 0; i < $.get$characters().length; ++i) {
    t1 = $.get$characters();
    if (i >= t1.length)
      throw $.ioore(i);
    t1 = t1[i];
    if ($.observeReads())
      $.notifyRead($.get$__changes(), 1, "guessedletter");
    if ($.$eq(t1, $.__$guessedletter)) {
      t1 = $.get$hyphens();
      if ($.observeReads())
        $.notifyRead($.get$__changes(), 1, "guessedletter");
      $.$indexSet$ax(t1, i, $.__$guessedletter);
    }
  }
};

$.init_autogenerated = function() {
  var t1, __root, __html0, __html1, __html2, __t, t2, t3;
  t1 = {};
  __root = document.body;
  __html0 = $.InputElement_InputElement(null);
  __html1 = $._ElementFactoryProvider_createElement_html("<p>\n            <template></template>\n        </p>");
  __html2 = $._ElementFactoryProvider_createElement_html("<p id=\"wrong\">\n            <template></template>\n        </p>");
  t1.__e0_1 = null;
  t1.__e1_2 = null;
  t1.__e2_3 = null;
  __t = $.Template$(__root);
  ...
  if (3 >= t2.length)
    throw $.ioore(3);
  t1.__e0_1 = $.$index$asx($.get$nodes$x(t2[3]), 1);
  t2 = __t.children;
  t2.push($.DomPropertyBinding$(new $.init_autogenerated_closure(), new $.init_autogenerated_closure0(t1), false, false));
  t3 = $.ConverterComponent$();
  t3.set$host(t3, t1.__e0_1);
  t2.push($.ComponentItem$(t3));
  __root.get$nodes;
  t3 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t3.length)
    throw $.ioore(3);
  t1.__e1_2 = $.$index$asx($.get$nodes$x(t3[3]), 3);
  t2.push($.DomPropertyBinding$(new $.init_autogenerated_closure1(), new $.init_autogenerated_closure2(t1), false, false));
  t3 = $.ConverterComponent$();
  t3.set$host(t3, t1.__e1_2);
  t2.push($.ComponentItem$(t3));
  __root.get$nodes;
  t3 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (3 >= t3.length)
    throw $.ioore(3);
  t1.__e2_3 = $.$index$asx($.get$nodes$x(t3[3]), 5);
  t2.push($.DomPropertyBinding$(new $.init_autogenerated_closure3(), new $.init_autogenerated_closure4(t1), false, false));
  t3 = $.ConverterComponent$();
  t3.set$host(t3, t1.__e2_3);
  t2.push($.ComponentItem$(t3));
  __root.get$nodes;
  t3 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (5 >= t3.length)
    throw $.ioore(5);
  t2.push($.LoopTemplate$($.$index$asx($.get$nodes$x(t3[5]), 1), new $.init_autogenerated_closure5(), new $.init_autogenerated_closure6()));
  __root.get$nodes;
  t3 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (7 >= t3.length)
    throw $.ioore(7);
  t2.push($.ConditionalTemplate$($.$index$asx($.get$nodes$x(t3[7]), 1), new $.init_autogenerated_closure7(), new $.init_autogenerated_closure8(__html0, __html1, __html2)));
  __root.get$nodes;
  t3 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (7 >= t3.length)
    throw $.ioore(7);
  t2.push($.ConditionalTemplate$($.$index$asx($.get$nodes$x(t3[7]), 3), new $.init_autogenerated_closure9(), new $.init_autogenerated_closure10()));
  __root.get$nodes;
  t3 = $._ChildNodeListLazy$(__root)._this.childNodes;
  if (7 >= t3.length)
    throw $.ioore(7);
  t2.push($.ConditionalTemplate$($.$index$asx($.get$nodes$x(t3[7]), 5), new $.init_autogenerated_closure11(), new $.init_autogenerated_closure12()));
  __t.create$0();
  __t.insert$0(__t);
};
...
$._ObservableMapKeyIterator$ = function(map) {
  return new $._ObservableMapKeyIterator(map, $.get$iterator$ax($.get$keys$x(map._liblib7$_map)), false);
};

$._ObservableMapValueIterator$ = function(map) {
  var t1 = map._liblib7$_map;
  ...
  while (true) {
    ...
    if (!t2)
      for (t1 = $.get$iterator$ax(t1); t1.moveNext$0();) {
        ...
        for (t2 = observable.get$$$_observers(), t2.get$head, n = t2._liblib1$_head; t2 = $.getInterceptor(n), n != null; n = t2.get$next(n)) {
...
$.set$ratio$x = function(receiver, value) {
  return $.getInterceptor$x(receiver).set$ratio(receiver, value);
};
...
Isolate.$lazy($, "__shadowTemplate", "ConverterComponent___shadowTemplate", "get$ConverterComponent___shadowTemplate", function() {
  return $.DocumentFragment_DocumentFragment$html("      <div class=\"x-converter\">\n        <span> <content select=\".label-one\"></content> </span>\n        <input type=\"text\" style=\"text-align:right\">\n          &lt; &gt;\n        <input type=\"text\">\n        <span> <content select=\".label-two\"></content> </span>\n      </div>\n    ");
});
Isolate.$lazy($, "characters", "characters", "get$characters", function() {
  return $.answer.split("");
});
Isolate.$lazy($, "hyphens", "hyphens", "get$hyphens", function() {
  return $.toObservable($.JSString_methods.replaceAll$2($.answer, $.RegExp_RegExp(".", true, false), "-").split(""));
});
